...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HTTPS_HOSTNAME, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_REST_CLIENT_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_PROVISIONING_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MEMFAULT_NCS_PROVISION_CERTIFICATES, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_MODEM_LIB_NET_IF_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_MODEM_LIB_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_AT_MONITOR_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LTE_LINK_CONTROL_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DATE_TIME_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MODEM_ANTENNA_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MEMFAULT_ROOT_CERT_STORAGE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MEMFAULT_ROOT_CERT_STORAGE_NRF9160_MODEM, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MEMFAULT_HTTP_ENABLE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MEMFAULT_HTTP_MAX_POST_SIZE, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MEMFAULT_HTTP_PERIODIC_UPLOAD, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MEMFAULT_HTTP_PERIODIC_UPLOAD_USE_DEDICATED_WORKQUEUE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MEMFAULT_HTTP_DEDICATED_WORKQUEUE_STACK_SIZE, 2048);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MEMFAULT_HTTP_PERIODIC_UPLOAD_INTERVAL_SECS, 3600);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MEMFAULT_TLS_CERTS_USE_PEM, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MEMFAULT_PROJECT_KEY, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MEMFAULT_ZEPHYR_FOTA_BACKEND_DUMMY, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MEMFAULT_METRICS_MEMFAULT_SYNC_SUCCESS, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MEMFAULT_PLATFORM_METRICS_CONNECTIVITY_BOOT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MEMFAULT_SYSTEM_TIME_SOURCE_DATETIME, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MEMFAULT_DATETIME_TIMESTAMP_EVENT_CALLBACK, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MEMFAULT_NRF_CONNECTIVITY_CONNECTED_TIME_NRF91X, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PTHREAD_BARRIER_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PTHREAD_COND_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PTHREAD_KEY_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PTHREAD_MUTEX_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PTHREAD_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PTHREAD_RWLOCK_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PTHREAD_SPINLOCK_LOG_LEVEL, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TIMER_LOG_LEVEL, 2);
